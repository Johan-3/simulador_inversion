...
// Seleccionamos el elemento que va a escuchar el evento (por ejemplo, un botón)
const boton = document.getElementById('simulador-btn');

// Añadimos un event listener al botón para que ejecute la función cuando se haga clic
